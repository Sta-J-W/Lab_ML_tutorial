...
class AOG(object):
    ...
    def _generate_aog_hierarchy_networkx(self, g):
        ...
        layer_2 = sorted(layer_2, key=lambda _node_name: g.nodes[_node_name]["value"])
    ...
    def _generate_layout_networkx(self, g, **kwargs):
        ...
        if n_row_interaction == 2:
            ...
            ys = np.array([0, 0.29, 0.58, 0.73, 0.88, 1.0])  # ugly codes
            ...
            ys = np.array([0, 0.18, 0.37, 0.50, 0.63, 0.76, 0.88, 1.0])  # ugly codes
