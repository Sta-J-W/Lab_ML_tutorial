...
import sys
sys.path.append("..")
from interaction.convert_matrix import get_harsanyi2reward_mat
...
def remove_noisy_greedy(rewards, CI, masks, harsanyi2reward, min_patterns, max_patterns=80, n_greedy=20,
    ...
    print(f"\n[n_greedy={n_greedy}] -- # coalitions: {len(final_retained_ids)} | error: {final_error:.4f} | ratio: {final_ratio:.4f}")
